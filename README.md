...
**Desenvolvido com ❤️ e ☕ por Walisson Vinicius**

Um portfólio moderno e altamente animado construído com Next.js 14, TypeScript, Tailwind CSS e shadcn/ui, apresentando um design inovador com efeitos de vidro fosco (glassmorphism), animações fluidas e experiência imersiva.
...
- **Framer Motion**: Animações avançadas e transições fluidas
...
- **Sobre Detalhado**: Timeline de experiências e habilidades
- **Formulário de Contato**: Interface intuitiva para comunicação
...
- **Gradientes Neon**: Cores vibrantes em gradientes suaves
- **Animações Fluidas**: Transições e microinterações envolventes
...
- **Semântica**: HTML semântico para screen readers
